...
exports.BywiseHelper = exports.BywiseAddressType = void 0;
const crypto_js_1 = __importDefault(require("crypto-js"));
const ethers_1 = require("ethers");
const InfoAddress_1 = require("../types/InfoAddress");
const web3_validator_1 = require("web3-validator");
var BywiseAddressType;
(function (BywiseAddressType) {
    BywiseAddressType["ADDRESS_TYPE_ZERO"] = "ADDRESS_TYPE_ZERO";
    BywiseAddressType["ADDRESS_TYPE_CONTRACT"] = "ADDRESS_TYPE_CONTRACT";
    BywiseAddressType["ADDRESS_TYPE_STEALTH"] = "ADDRESS_TYPE_STEALTH";
    BywiseAddressType["ADDRESS_TYPE_USER"] = "ADDRESS_TYPE_USER";
})(BywiseAddressType || (exports.BywiseAddressType = BywiseAddressType = {}));
class BywiseHelper {
...
BywiseHelper.encodeBWSAddress = (typeAddress, ethAddress, tag) => {
...
BywiseHelper.isStealthAddress = (address) => {
