...
class Slice {
    constructor(slice) {
        ...
        this.next = (_f = slice === null || slice === void 0 ? void 0 : slice.next) !== null && _f !== void 0 ? _f : '';
        this.created = (_g = slice === null || slice === void 0 ? void 0 : slice.created) !== null && _g !== void 0 ? _g : '';
        this.lastBlockHash = (_h = slice === null || slice === void 0 ? void 0 : slice.lastBlockHash) !== null && _h !== void 0 ? _h : '';
        this.hash = (_j = slice === null || slice === void 0 ? void 0 : slice.hash) !== null && _j !== void 0 ? _j : '';
        this.sign = (_k = slice === null || slice === void 0 ? void 0 : slice.sign) !== null && _k !== void 0 ? _k : '';
    }
    getMerkleRoot() {
        let merkleRoot = '';
    ...
    isValid() {
        ...
        if (!BywiseHelper_1.BywiseHelper.isValidAddress(this.next))
            throw new Error('invalid slice next address ' + this.next);
