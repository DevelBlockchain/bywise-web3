...
class Block {
    constructor(block) {
        ...
        this.nextSlice = (_f = block === null || block === void 0 ? void 0 : block.nextSlice) !== null && _f !== void 0 ? _f : '';
        this.nextBlock = (_g = block === null || block === void 0 ? void 0 : block.nextBlock) !== null && _g !== void 0 ? _g : '';
        this.created = (_h = block === null || block === void 0 ? void 0 : block.created) !== null && _h !== void 0 ? _h : '';
        this.lastHash = (_j = block === null || block === void 0 ? void 0 : block.lastHash) !== null && _j !== void 0 ? _j : '';
        this.hash = (_k = block === null || block === void 0 ? void 0 : block.hash) !== null && _k !== void 0 ? _k : '';
        this.sign = (_l = block === null || block === void 0 ? void 0 : block.sign) !== null && _l !== void 0 ? _l : '';
        this.externalTxID = (_m = block === null || block === void 0 ? void 0 : block.externalTxID) !== null && _m !== void 0 ? _m : [];
    }
    getMerkleRoot() {
        let merkleRoot = '';
