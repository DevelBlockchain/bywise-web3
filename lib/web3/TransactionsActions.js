...
class TransactionsActions {
    constructor(web3) {
        ...
        this.countTxs = (...args_2) => __awaiter(this, [...args_2], void 0, function* (parameters = {}) {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.waitConfirmation = (txHash_1, ...args_3) => __awaiter(this, [txHash_1, ...args_3], void 0, function* (txHash, timeout = 30000) {
            let uptime = Date.now();
            let response;
