...
class BlocksActions {
    constructor(web3) {
        ...
        this.findLastBlocks = (limit = 1, chain) => __awaiter(this, void 0, void 0, function* () {
            let lastBlocks = [];
        ...
        this.findBlocksFromHeight = (height, chain, limit = 1) => __awaiter(this, void 0, void 0, function* () {
            let lastBlocks = [];
            let lastBlockHeight = -1;
            yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.api.getBlocks(node, {
            ...
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!req.error) {
                    return {
                        ...
                        slice: req.data.slice ? new types_1.Slice(req.data.slice) : null,
