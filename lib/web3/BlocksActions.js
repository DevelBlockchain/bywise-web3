    ...
    constructor(web3) {
        this.sendBlock = (block) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.sendAll((node) => __awaiter(this, void 0, void 0, function* () {
                return yield this.web3.network.getAPI(node).publishNewBlock(node, block);
            }));
        });
        this.findLastBlocks = (...args_1) => __awaiter(this, [...args_1], void 0, function* (limit = 1, chain) {
            ...
            yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getBlocks(node, chain, {
                    limit,
                    status: 'mined',
                });
                if (!req.error) {
        ...
        this.getBlockByHash = (blockHash) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getBlockByHash(node, blockHash);
                if (!req.error) {
                    return req.data;
                }
            }));
        ...
        this.getBlockPackByHeight = (chain, height) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getBlockPackByHeight(node, chain, height);
                if (!req.error) {
                    return {
        ...
        this.getBlocks = (chain_1, ...args_1) => __awaiter(this, [chain_1, ...args_1], void 0, function* (chain, parameters = {}) {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getBlocks(node, chain, parameters);
                if (!req.error) {
                    return req.data;
                }
            }));
        ...
        this.countBlocks = (chain) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).countBlocks(node, chain);
                if (!req.error) {
        ...
        this.getSlicesFromBlock = (sliceHash) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getSlicesFromBlock(node, sliceHash);
                if (!req.error) {
                    return req.data;
                }
            }));
