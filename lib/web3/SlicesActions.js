    ...
    constructor(web3) {
        this.sendSlice = (slice) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.sendAll((node) => __awaiter(this, void 0, void 0, function* () {
                return yield this.web3.network.getAPI(node).publishNewSlice(node, slice);
            }));
        });
        this.getSliceByHash = (sliceHash) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getSliceByHash(node, sliceHash);
                if (!req.error) {
                    return req.data;
                }
            }));
        });
        this.getSlices = (chain_1, ...args_1) => __awaiter(this, [chain_1, ...args_1], void 0, function* (chain, parameters = {}) {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getSlices(node, chain, parameters);
                if (!req.error) {
                    return req.data;
                }
            }));
        ...
        this.countSlices = (chain) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).countSlices(node, chain);
                if (!req.error) {
        ...
        this.getTransactionsFromSlice = (sliceHash) => __awaiter(this, void 0, void 0, function* () {
            return yield this.web3.network.findAll((node) => __awaiter(this, void 0, void 0, function* () {
                let req = yield this.web3.network.getAPI(node).getTransactionsFromSlice(node, sliceHash);
                if (!req.error) {
                    return req.data;
                }
            }));
